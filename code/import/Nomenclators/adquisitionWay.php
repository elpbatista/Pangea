...
$nomenclatorTable = "pangea:AdquisitionWay";
$parent = "pangea:AdquisitionWay";
//$schemeName = "Esquema de Conceptos";
$excludeNode = array ("Vía de Adquisición" );

//Leo el archivo XML
$z = new XMLReader ();
if (! $z->open ( dirname ( __FILE__ ) . '/../data/via_de_adquisicion.xml', LIBXML_NOBLANKS )) {
