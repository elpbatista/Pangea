...
$nomenclatorTable = "pangea:Availability";
$parent = "pangea:Availability";
//$schemeName = "Esquema de Conceptos";
$excludeNode = array ("Disponibilidad" );

//Leo el archivo XML
$z = new XMLReader ();
if (! $z->open ( dirname ( __FILE__ ) . '/../data/disponibilidad.xml', LIBXML_NOBLANKS )) {
