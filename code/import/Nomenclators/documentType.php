...
$nomenclatorTable = "pangea:DocumentType";
$parent = "pangea:DocumentType";
//$schemeName = "Esquema de Conceptos";
$excludeNode = array ("Tipo de documento" );

//Leo el archivo XML
$z = new XMLReader ();
if (! $z->open ( dirname ( __FILE__ ) . '/../data/tipo_documento.xml', LIBXML_NOBLANKS )) {
