...
require_once ZENDAPI_INCLUDE_DIR .'Log/Filter/Interface.php';

/** @see Zend_Log_FactoryInterface */
require_once ZENDAPI_INCLUDE_DIR .'Log/FactoryInterface.php';
    ...
    implements Zend_Log_Filter_Interface, Zend_Log_FactoryInterface
{
    ...
    static protected function _parseConfig($config)
    {
        ...
        if (!is_array($config)) {
            require_once ZENDAPI_INCLUDE_DIR .'Log/Exception.php';
