...
require_once ZENDAPI_INCLUDE_DIR .'Log/Writer/Abstract.php';

/** Zend_Log_Formatter_Firebug */
require_once ZENDAPI_INCLUDE_DIR .'Log/Formatter/Firebug.php';

/** Zend_Wildfire_Plugin_FirePhp */
require_once ZENDAPI_INCLUDE_DIR .'Wildfire/Plugin/FirePhp.php';
